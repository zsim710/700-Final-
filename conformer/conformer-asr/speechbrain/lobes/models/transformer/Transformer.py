...
class TransformerInterface(nn.Module):
    ...
    def __init__(
        ...
        if num_encoder_layers > 0:
            ...
            freeze_layers(self.encoder, freeze_encoder_layers)
        ...
        if num_decoder_layers > 0:
            ...
            freeze_layers(self.decoder, freeze_decoder_layers)
...
def freeze_layers(component, n):
    for layer in component.layers[:n]:
